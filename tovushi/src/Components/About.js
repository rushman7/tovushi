      ...
      <React.Fragment>
        ...
        <div className="about">
          <div className="about-content">
            ...
            <img className="images" src={FrontSide} alt="FrontSide" />
          </div>
          <div className="about-content">
            <p className="about-text-2">
              A dance team, a soccer team, chess, drums and many more. 
            </p>
            <img className="images" src={Drums} alt="Drums" />
          </div>
          <div className="about-content">
            ...
            <img className="images" src={Soccer} alt="Soccer" />
          </div>
          <div className="about-content">
            ...
            <img className="images" src={PurimParty} alt="PurimParty" />
          </div>
          <div className="about-content">
            ...
            <img className="images" src={DanceGroup} alt="DanceGroup" />
          </div>
        </div>
      </React.Fragment>
    )
